...
class Gestion(models.Model):
    ...
    actividad = models.ForeignKey(Actividad, models.DO_NOTHING, db_column='actividad', blank=True, null=True)
    interes = models.ForeignKey('Interes', models.DO_NOTHING, db_column='interes', blank=True, null=True)
    producto = models.ForeignKey('Producto', models.DO_NOTHING, db_column='producto', blank=True, null=True)
    direccion = models.CharField(max_length=100, blank=True, null=True)
    telefono = models.CharField(max_length=100, blank=True, null=True)
    fijo = models.CharField(max_length=100, blank=True, null=True)
...
class Interes(models.Model):
    nombre = models.CharField(max_length=1011, blank=True, null=True)
